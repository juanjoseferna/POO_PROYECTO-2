...
private:
    ...
    int x1Facil = 284, x2Facil = 464, y1Facil = 204, y2Facil = 260;
    int x1Normal = 223, x2Normal = 508, y1Normal = 306, y2Normal = 360;
    int x1Volver = 570, x2Volver = 715, y1Volver = 433, y2Volver = 469;
    bool salida;
